...
- **Bublitt 플랫폼 연동을 통한 통합 어드민 관리 시스템 개발**
  - **Bublitt을 연계**하여 LLM 응답 제어 및 대화 주제/답변 관리 기능 구현
  - **Spring Scheduler와 Spring Batch를 이용해** 시스템 로그 및 사용자 요청 데이터를 주/월 단위로 저장

- **모니터링 및 운영 안정성 강화**
  - **Grafana, Prometheus** 기반의 **실시간 모니터링 및 알림 시스템** 구성  
  - **Kubernetes, AWS, Docker, Jenkins, Nginx** 환경에서의 안정적 배포 및 운영 자동화 구현
